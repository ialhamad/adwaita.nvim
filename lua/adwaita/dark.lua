...
M.set = function()
	...
	highlight("CursorLine", "none", colors.libadwaita_dark_alt_2, "none", "none")
	...
	highlight("ErrorMsg", colors.red_3, colors.libadwaita_dark, "undercurl", "none")
	...
	highlight("TSProperty", colors.light_3, "none", "none", "none")
	...
	highlight("GitSignsAdd", colors.green_6, colors.libadwaita_dark, "none", "none")
	highlight("GitSignsChange", colors.blue_6, colors.libadwaita_dark, "none", "none")
	highlight("GitSignsDelete", colors.red_1, colors.libadwaita_dark, "none", "none")

	highlight("DiagnosticUnderlineError", colors.red_3, "none", "undercurl", "none")
	highlight("DiagnosticUnderlineWarn", colors.yellow_4, "none", "undercurl", "none")
	highlight("DiagnosticUnderlineInfo", colors.blue_1, "none", "undercurl", "none")
	highlight("DiagnosticUnderlineHint", colors.light_3, "none", "undercurl", "none")
end
